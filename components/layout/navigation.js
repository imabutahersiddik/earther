...
const Navbar = ({ menuOpen, setMenuOpen }) => {
    ...
    <nav className="flex justify-between align-middle text-lg ">
            <span className="font-Bai font-extrabold text-2xl"><Link href='/' passHref>Earther.</Link></span>
        {!menuOpen && (<>
                    ...
                    <li>
                        ...
                        {showDropDown && (
                            <div className=" font-semibold text-gray-600 absolute bg-white  z-50 list-none divide-y divide-gray-100 rounded-md w-[200px]  shadow-xl my-4 animate-fade-in-down" >
                                <ul className="py-1" >
                                    <li>
                                        <span className=" text-lg hover:bg-gray-100  block px-6 py-2 cursor-pointer" onClick={() => handleRoute('discovery')}>Discovery </span>
                                    </li>
                                    <li>
                                        <span className=" text-lg hover:bg-gray-100  block px-6 py-2 cursor-pointer" onClick={() => handleRoute('nature')}>Nature</span>
                                    </li>
                                    <li>
                                        <span className=" text-lg hover:bg-gray-100 block px-6 py-2 cursor-pointer" onClick={() => handleRoute('Consequences')}>Consequences</span>
                                    </li>
                                    <li>
                                        <span className=" text-lg hover:bg-gray-100  block px-6 py-2 cursor-pointer" onClick={() => handleRoute('ghost-effects')}>Ghost Effects</span>
                                    </li>
                                </ul>
                            </div>
                        )}
            ...
            {menuOpen &&
                <MobileMenu>
                            ...
                            {showDropDown && (
                                <div className="font-semibold text-gray-600 z-50 list-none divide-y divide-gray-100 rounded-md w-full  my-4 animate-fade-in-down" >
                                    <ul className="py-1" >
                                        ...
                                        <li>
                                            <span className=" text-lg hover:bg-gray-100  block px-6 py-2 cursor-pointer" onClick={() => handleRoute('research')}>Research </span>
                                        </li>
                                        <li>
                                            <span className=" text-lg hover:bg-gray-100  block px-6 py-2 cursor-pointer" onClick={() => handleRoute('ghost-effects')}>Ghost Effects</span>
                                        </li>
                                        <li>
                                            <span className=" text-lg hover:bg-gray-100 block px-6 py-2 cursor-pointer" onClick={() => handleRoute('environment')}>Environment </span>
                                        </li>
                                        <li>
                                            <span className=" text-lg hover:bg-gray-100  block px-6 py-2 cursor-pointer" onClick={() => handleRoute('Nature')}>Nature </span>
                                        </li>
                    ...
                    <div className="flex justify-evenly w-1/4 md:w-1/6 my-auto  mx-auto">
                        <span className=" hover:font-semibold hover:underline text-xl font-medium text-gray-800"><a href='https://twitter.com/earther'><AiOutlineTwitter className='w-7 h-7 my-auto mx-1' /></a></span>
                        <span className=" hover:font-semibold hover:underline text-xl font-medium text-gray-800"><a href='https://github.com/imabutahersiddik/earther'><AiOutlineGithub className='w-7 h-7 my-auto mx-1' /></a></span>
                    </div>
                </MobileMenu>}
        </div>
    );
